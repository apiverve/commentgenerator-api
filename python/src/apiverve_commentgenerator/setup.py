...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/commentgenerator',
        'Source': 'https://github.com/apiverve/commentgenerator-api',
        'Bug Tracker': 'https://github.com/apiverve/commentgenerator-api/issues'
    },
    classifiers=[
